      ...
      <div className="h-full flex items-center">
        ...
        >
          {PROJECTS.map((project) => (
            <div
              key={project.num}
              className="w-[85vw] sm:w-[500px] md:w-[600px] h-full shrink-0 relative glass-card rounded-3xl overflow-hidden border border-white/5 flex flex-col justify-between p-8 sm:p-10 select-none group transform-gpu"
            ...
            >
              ...
              {/* Title & Description */}
              <div className="z-10 mt-12 flex-grow">
